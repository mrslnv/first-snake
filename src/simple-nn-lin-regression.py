...
W = tf.get_variable("W",shape=[2,2],initializer=initializer)
b = tf.get_variable("b",shape=[2],initializer=initializer)
...
loss = tf.nn.sparse_softmax_cross_entropy_with_logits(logits,y_,name="loss")
